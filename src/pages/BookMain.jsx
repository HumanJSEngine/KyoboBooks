...
const BookMain = (props) => {
    ...
    const bookdata = parseInt(params.id);
    ...
    console.log('책목록', props.bookList);
        ...
        <div>
            <Wrapper>
                <Left>
                    ...
                    <Info>
                        <span className='publish'>{book.publisher}</span>
                        <span className='release'>{book.publicDt}</span>
                    </Info>
                </Left>
                <Right>
                    <div
                    ...
                    <PriceList>
                        ...
                        <span className='saleprice'>
                            정가 {cal(book.price)?.toLocaleString()}원
                        </span>
                    ...
                    <div className='deliveryset'>
                        <div className='delivery'>
                            ...
                            <span className='remaintime'>
                                ...
                                {second < 10 ? '0' + second : second} 내 주문시
                                / 수도권 기준)
                            </span>
                        </div>
                ...
                <BookInfo>
                    ...
                    <span className='bookintro'>
                        <h2>책 간략소개</h2>
                        <br />
                        {book.overview ? book.overview : 'DB가 없읍니다'}
                    </span>
                </BookInfo>
            </Wrapper>
            <Wrapper2>
                <Payment>
                    <Title>
                        ...
                        <Price>
                            <span className='val'>
                                {cal(book.price * x)?.toLocaleString()}
                            </span>
